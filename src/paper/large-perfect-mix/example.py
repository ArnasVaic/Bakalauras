...
mix_config = MixConfig('perfect', [ 1.0 * 3600 ])
...
show_solution_frames(t, c, frames, 0, config=config, filename='../paper/images/mixing/perfect-mix-ord-1-c1.png')
show_solution_frames(t, c, frames, 1, config=config, filename='../paper/images/mixing/perfect-mix-ord-1-c2.png')
show_solution_frames(t, c, frames, 2, config=config, filename='../paper/images/mixing/perfect-mix-ord-1-c3.png')