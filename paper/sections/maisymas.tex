...
% \begin{figure}[h!]
% \centering
% \includegraphics[width=\textwidth]{images/rnd-mix-c0-1.png} \\
% \includegraphics[width=\textwidth]{images/rnd-mix-c1-1.png} \\
% \includegraphics[width=\textwidth]{images/rnd-mix-c2-1.png}
...
\begin{figure}[h!]
  ...
  \caption{Tobulo maišymo poveikis skaitiniame sprendinyje. Modelio parametrai atitinka reakciją vykstančia $1000\degree C$ temperatūroje. Reakcijos erdvės rezoliucija $40\times40$. Išmaišymo laikas -- $1\text{h}. $}
...
\begin{figure}[h!]
    ...
    \caption{Reakcijos trukmės priklausomybė nuo išmaišymo momento. Modelio parametrai atitinka reakciją $1000\degree C$ temperatūroje. Reakcijos erdvės rezoliucija $40\times40$. }
...
\end{tikzpicture}
\caption{ Du kartus padidinta reakcijos erdvė. }

\label{large-initial-conditions}
\end{figure}

\subsection{Maišymo modelių pritaikymas didesnėms erdvėms}

\subsubsection*{Atsitiktinis maišymas}

Praplėsti atsitiktinį maišymo modelį didesnėms reakcijos erdvėms yra trivialu -- sugeneruojame $N^2\text{-permutaciją}$ ir $N^2$ atsitiktinių kampų $\theta_1, \theta_2, \dots, \theta_{N^2}$, kur $N$ yra sričių skaičius didesnėje erdvėje. Tuomet maišymo metu, kiekvieną sritis įgauna nauja poziciją bei posukio kampą.
...
% \begin{figure}[h!]
%     \centering
%     \includegraphics[width=0.5\textwidth]{../paper/images/mix-end-large-1.png}
...
\subsection{Tobulo maišymo rezultatai didesnėse erdvėse}

Viena iš pageidautinų maišymo modelių savybių -- nuoseklus rezultatai, kurie būtų nepriklausomi nuo reakcijos erdvės dydžio, kurią modeliuojame. Tokiu atveju, galėtume daryti reikšmingas išvadas apie maišymo poveikį reakcijai modeliuojant mažas reakcijos erdves lyginant su tuo tikra reakcija. Norint patikrinti ar tobulo maišymo modelis pasižymi šia savybe, pirmiausia galime palyginti kaip 
