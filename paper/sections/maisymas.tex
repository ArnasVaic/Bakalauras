...
\begin{figure}[h!]
    \centering
    \includegraphics[width=0.5\textwidth]{images/bad-mix-qnt-1.png}
...
\begin{figure}[h!]
    \centering
    \includegraphics[width=0.5\textwidth]{../paper/images/optimal-mix-qnt-1.png}
...
\begin{figure}[h!]
    \centering
    \includegraphics[width=0.5\textwidth]{../paper/images/mix-end-1.png}
