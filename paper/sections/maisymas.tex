...
Nors optimalūs maišymo laikai beveik sutampa, gali būti naudinga ištirti, kaip jie kinta priklausomai nuo modeliuojamos srities dydžio. Tam galime pasinaudoti auksinio pjūvio paieškos algoritmu, kuris leidžia efektyviai rasti funkcijos minimumą tam tikrame intervale. Šis metodas paremtas tuo, kad tiriamas taškas pasirenkamas pasinaudojant auksinio pjūvio santykiu, taip sumažinant tiriamą intervalą be reikalo nepervertinant viso funkcijos grafiko. Dėl savo efektyvumo ir nereikalingos išvestinių skaičiavimo, šis metodas ypač tinkamas optimizuoti brangiai skaičiuojamas ar netiesines funkcijas, tokias kaip reakcijos trukmė priklausomai nuo maišymo trukmės. Norint kad algoritmas suveiktų funkcija, kurios ekstremumo ieškome, privalo būti unimodali, ką reakcijos trukmės ir maišymo momento priklausomybės grafikas tenkina.
